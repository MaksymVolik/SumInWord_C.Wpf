...
namespace SumInWord_C.Wpf.BusinessLogic
{
    ...
    public static class AmountConverter
    {
        ...
        internal static readonly string[,] _hundredsNames = {
            ...
            {"", "сто", "двісті", "триста", "чотириста", "п'ятьсот", "шістсот", "сімсот", "вісімсот", "дев'ятсот"}
        };
        ...
        internal static readonly string[,] _unitScaleNames = {
            ...
            {"", "гривня", "гривні", "гривень", "тисяча", "тисячі", "тисяч", "мільйон", "мільйона", "мільйонів", "мільярд", "мільярди", "мільярдів", "трильйон", "трильйона", "трильйонів"}
        };
        ...
        public static string ConvertAmountToWords(decimal amountToConvert, byte lang)
        {
            ...
            try
            {
                ...
                {
                    return lang == 1 ? "знадто велике число" : "слишком большое число";
                }
